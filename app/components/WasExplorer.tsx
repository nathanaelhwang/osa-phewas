      ...
      <div className="explorer-grid">
        ...
        <aside className="feature-inspector" aria-labelledby="was-selected-feature-title">
          {selected && activeMetadata ? <>
            ...
            {selected.label_review_required ? <p className="quality-warning">Display label uses a fallback medication-class name and remains under review.</p> : null}
            {selected.n !== null || selected.n_secondary !== null ? <p className="was-feature-count-note">These are analytic or overall feature-positive counts, not OSA exposure-by-outcome cells.</p> : null}
